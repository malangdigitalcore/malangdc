    ...
    <div class="page-content">
      ...
      <div class="panel">
        <header class="panel-heading">
          ...
          <h3 class="panel-title">Data Alamat</h3>
        </header>
        <div class="panel-body">
          <div class="row">
            <div class="col-sm-12">
              <div class="margin-bottom-15">
                <a href="ms_alamat_form.php">
          ...
          <table class="table table-hover dataTable table-striped width-full" data-plugin="dataTable">
            ...
            <tbody>
              ...
              <tr>
                  ...
                  <td style='text-align:center;vertical-align:middle'><b><?php echo $data['kode_alamat']?></b></td>
                  ...
                  <td style='text-align:center;vertical-align:middle'>
                    ...
                    onclick="window.location.href='ms_alamat_form.php?mode=edit&idmode=<?php echo $data['kode_alamat']?>'">
